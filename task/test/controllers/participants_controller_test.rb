...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { contactno: @participant.contactno, email: @participant.email, name: @participant.name } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { contactno: @participant.contactno, email: @participant.email, name: @participant.name } }
